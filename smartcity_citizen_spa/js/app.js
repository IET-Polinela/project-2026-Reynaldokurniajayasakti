...
function switchTab(tabName) {
    ...
    (document.getElementById('tab-feed') || document.getElementById('tabFeedKota'))?.classList.toggle('active', tabName === 'feed');
    (document.getElementById('tab-my-reports') || document.getElementById('tabLaporanSaya'))?.classList.toggle('active', tabName === 'my_reports');
...
async function loadSummaryStats() {
    try {
        // Ambil data ringkasan dalam jumlah besar agar badge status tetap akurat.
