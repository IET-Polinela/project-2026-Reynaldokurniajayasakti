...
function handleRouting() {
    ...
    if (hash === '#dashboard') {
        ...
        appContent.innerHTML = `
            <div class="row">
                <div class="col-md-3 mb-4">
                    <button type="button" id="btnBukaModal" class="btn btn-primary w-100 mb-3 fw-bold py-2 shadow-sm" data-bs-toggle="modal" data-bs-target="#reportModal">
                        <i class="bi bi-plus-circle-fill me-2"></i>Laporan Baru
                    </button>
                    
                    <div class="list-group shadow-sm mb-3">
                        <button type="button" id="tabFeedKota" class="list-group-item list-group-item-action active">
                            <i class="bi bi-rss-fill me-2"></i>Feed Kota (Semua)
                        </button>
                        <button type="button" id="tabLaporanSaya" class="list-group-item list-group-item-action">
        ...
        try {
            const tFeed = document.getElementById('tabFeedKota');
            const tMy = document.getElementById('tabLaporanSaya');
